...
from core.model.mca import ST_MHAtt
...
class Execution:
    ...
    def eval(self, dataset, state_dict=None, valid=False):
        ...
        if valid:
            ...
            print("Sparse Parameter: %.02f\n" % st_MHAtt.sparse_parameter.item())
            ...
            logfile.write("Sparse Parameter: %.02f\n" % st_MHAtt.sparse_parameter.item())
            for ansType in vqaEval.accuracy['perAnswerType']:
